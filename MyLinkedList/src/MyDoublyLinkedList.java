...
public class MyDoublyLinkedList<E> extends MyAbstractList<E> {
    ...
    public void addFirst(E o) {
        ...
        newNode.next = head;
        // for doubly linked reference the previous
    ...
    public void addLast(E o) {
        if (tail == null) {
            ...
            // double link back to prior tail
    ...
    public E removeFirst() {
        if (size == 0) return null;
            ...
            //if (size == 0) head = null;
            // doubly linked reset previous of new head
            head.previous = null;
    ...
    public E removeLast() {
        ...
        else
        {
            ...
            //tail.next = head;
            // nothing to modify for doubly linked as previous is unchanged
            size--;
            return temp.element;
        }
    }
